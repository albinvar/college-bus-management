                                            ...
                                            <tr>
                                                ...
                                                <td class="size-px whitespace-nowrap">
                                                    <div class="px-6 py-3 item-center">
                                                        <button class="py-2 px-3 inline-flex items-center gap-x-2 text-xs font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-non">
                                                            Check In
                                                        </button>
                                                    </div>
                                                </td>
